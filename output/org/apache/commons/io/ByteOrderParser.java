...
public final class ByteOrderParser {
     ...
     */
    public static java.nio.ByteOrder parseByteOrder(final java.lang.String value) {
        if (java.nio.ByteOrder.BIG_ENDIAN.toString().equals(value)) {
            return java.nio.ByteOrder.BIG_ENDIAN;
        }
        if (java.nio.ByteOrder.LITTLE_ENDIAN.toString().equals(value)) {
            return java.nio.ByteOrder.LITTLE_ENDIAN;
        }
        throw new java.lang.IllegalArgumentException(((((("Unsupported byte order setting: " + value) + ", expeced one of ") + (java.nio.ByteOrder.LITTLE_ENDIAN)) + ", ") + (java.nio.ByteOrder.BIG_ENDIAN)));
    }
}
