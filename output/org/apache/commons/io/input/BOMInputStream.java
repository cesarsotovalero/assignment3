 ...
 * @since 2.0
 */
/* method "hasBOM" was removed from this class because it was not covered by the test suite */
/* method "hasBOM" was removed from this class because it was not covered by the test suite */
...
public class BOMInputStream extends org.apache.commons.io.input.ProxyInputStream {
    ...
    private static final java.util.Comparator<org.apache.commons.io.ByteOrderMark> ByteOrderMarkLengthComparator = new java.util.Comparator<org.apache.commons.io.ByteOrderMark>() {
        @java.lang.Override
        public int compare(final org.apache.commons.io.ByteOrderMark bom1, final org.apache.commons.io.ByteOrderMark bom2) {
    ...
    public BOMInputStream(final java.io.InputStream delegate, final boolean include, final org.apache.commons.io.ByteOrderMark... boms) {
        ...
        final java.util.List<org.apache.commons.io.ByteOrderMark> list = java.util.Arrays.asList(boms);
        // Sort the BOMs to match the longest BOM first because some BOMs have the same starting two bytes.
        java.util.Collections.sort(list, org.apache.commons.io.input.BOMInputStream.ByteOrderMarkLengthComparator);
        this.boms = list;
    }
     ...
     */
    private boolean matches(final org.apache.commons.io.ByteOrderMark bom) {
