...
public class UnixLineEndingInputStream extends java.io.InputStream {
     ...
     * @param ensureLineFeedAtEndOfFile
     * 		true to ensure that the file ends with LF
     */
    public UnixLineEndingInputStream(final java.io.InputStream in, final boolean ensureLineFeedAtEndOfFile) {
        this.target = in;
