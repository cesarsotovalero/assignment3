 ...
 */
/* method "consume" was removed from this class because it was not covered by the test suite */
/* method "noteError" was removed from this class because it was not covered by the test suite */
/* method "remove" was removed from this class because it was not covered by the test suite */
/* method "removeAllObservers" was removed from this class because it was not covered by the test suite */
public class ObservableInputStream extends org.apache.commons.io.input.ProxyInputStream {
    public abstract static class Observer {
         ...
         * @param pLength
         * 		The number of bytes, which have been stored in the byte array.
         * @throws IOException
         * 		if an i/o-error occurs
         */
         ...
         * 		if an i/o-error occurs
         */
        void error(final java.io.IOException pException) throws java.io.IOException {
            throw pException;
        }
    }

    private final java.util.List<org.apache.commons.io.input.ObservableInputStream.Observer> observers = new java.util.ArrayList<>();
     ...
     */
    public ObservableInputStream(final java.io.InputStream pProxy) {
        super(pProxy);
    }
     ...
     * 		the observer to add
     */
    public void add(final org.apache.commons.io.input.ObservableInputStream.Observer pObserver) {
    ...
    public int read() throws java.io.IOException {
        ...
        try {
            result = super.read();
        } catch (final java.io.IOException pException) {
            ioe = pException;
        }
        if (ioe != null) {
            noteError(ioe);
    ...
    @java.lang.Override
    public int read(final byte[] pBuffer) throws java.io.IOException {
        int result = 0;
        java.io.IOException ioe = null;
        try {
    ...
    @java.lang.Override
    public int read(final byte[] pBuffer, final int pOffset, final int pLength) throws java.io.IOException {
        int result = 0;
        java.io.IOException ioe = null;
        try {
     ...
     * 		passed down.
     */
    protected void noteDataBytes(final byte[] pBuffer, final int pOffset, final int pLength) throws java.io.IOException {
        for (final org.apache.commons.io.input.ObservableInputStream.Observer observer : getObservers()) {
     ...
     * 		passed down.
     */
    protected void noteDataByte(final int pDataByte) throws java.io.IOException {
        for (final org.apache.commons.io.input.ObservableInputStream.Observer observer : getObservers()) {
