...
public class CopyUtils {
     ...
     */
    public static void copy(final byte[] input, final java.io.OutputStream output) throws java.io.IOException {
        output.write(input);
    }
     ...
     */
    @java.lang.Deprecated
    public static void copy(final byte[] input, final java.io.Writer output) throws java.io.IOException {
     ...
     * 		In case of an I/O problem
     */
    public static void copy(final byte[] input, final java.io.Writer output, final java.lang.String encoding) throws java.io.IOException {
        final java.io.ByteArrayInputStream in = new java.io.ByteArrayInputStream(input);
     ...
     * 		In case of an I/O problem
     */
    public static int copy(final java.io.InputStream input, final java.io.OutputStream output) throws java.io.IOException {
        final byte[] buffer = new byte[org.apache.commons.io.CopyUtils.DEFAULT_BUFFER_SIZE];
        int count = 0;
        int n = 0;
     ...
     * 		In case of an I/O problem
     */
    public static int copy(final java.io.Reader input, final java.io.Writer output) throws java.io.IOException {
        final char[] buffer = new char[org.apache.commons.io.CopyUtils.DEFAULT_BUFFER_SIZE];
        int count = 0;
        int n = 0;
        while ((-1) != (n = input.read(buffer))) {
            output.write(buffer, 0, n);
     ...
     */
    @java.lang.Deprecated
    public static void copy(final java.io.InputStream input, final java.io.Writer output) throws java.io.IOException {
     ...
     * 		In case of an I/O problem
     */
    public static void copy(final java.io.InputStream input, final java.io.Writer output, final java.lang.String encoding) throws java.io.IOException {
     ...
     */
    @java.lang.Deprecated
    public static void copy(final java.io.Reader input, final java.io.OutputStream output) throws java.io.IOException {
        // make explicit the dependency on the default encoding
     ...
     * @since 2.5
     */
    public static void copy(final java.io.Reader input, final java.io.OutputStream output, final java.lang.String encoding) throws java.io.IOException {
     ...
     */
    @java.lang.Deprecated
    public static void copy(final java.lang.String input, final java.io.OutputStream output) throws java.io.IOException {
     ...
     * @since 2.5
     */
    public static void copy(final java.lang.String input, final java.io.OutputStream output, final java.lang.String encoding) throws java.io.IOException {
        final java.io.StringReader in = new java.io.StringReader(input);
        final java.io.OutputStreamWriter out = new java.io.OutputStreamWriter(output, encoding);
        org.apache.commons.io.CopyUtils.copy(in, out);
        // XXX Unless anyone is planning on rewriting OutputStreamWriter, we
     ...
     * 		In case of an I/O problem
     */
    public static void copy(final java.lang.String input, final java.io.Writer output) throws java.io.IOException {
        output.write(input);
    }
}
