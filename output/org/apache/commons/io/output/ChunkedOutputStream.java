...
public class ChunkedOutputStream extends java.io.FilterOutputStream {
     ...
     */
    public ChunkedOutputStream(final java.io.OutputStream stream, final int chunkSize) {
        super(stream);
        if (chunkSize <= 0) {
     ...
     * 		the stream to wrap
     */
    public ChunkedOutputStream(final java.io.OutputStream stream) {
        this(stream, org.apache.commons.io.output.ChunkedOutputStream.DEFAULT_CHUNK_SIZE);
    }
     ...
     */
    @java.lang.Override
    public void write(final byte[] data, final int srcOffset, final int length) throws java.io.IOException {
        int bytes = length;
        int dstOffset = srcOffset;
        while (bytes > 0) {
            final int chunk = java.lang.Math.min(bytes, chunkSize);
