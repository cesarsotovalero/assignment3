...
public class ChunkedWriter extends java.io.FilterWriter {
     ...
     */
    public ChunkedWriter(final java.io.Writer writer, final int chunkSize) {
        super(writer);
        if (chunkSize <= 0) {
     ...
     * 		the writer to wrap
     */
    public ChunkedWriter(final java.io.Writer writer) {
        this(writer, org.apache.commons.io.output.ChunkedWriter.DEFAULT_CHUNK_SIZE);
    }
     ...
     */
    @java.lang.Override
    public void write(final char[] data, final int srcOffset, final int length) throws java.io.IOException {
        int bytes = length;
