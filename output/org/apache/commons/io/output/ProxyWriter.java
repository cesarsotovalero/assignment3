...
public class ProxyWriter extends java.io.FilterWriter {
     ...
     */
    public ProxyWriter(final java.io.Writer proxy) {
        super(proxy);
     ...
     */
    @java.lang.Override
    public java.io.Writer append(final char c) throws java.io.IOException {
        try {
            beforeWrite(1);
            out.append(c);
            afterWrite(1);
     ...
     */
    @java.lang.Override
    public java.io.Writer append(final java.lang.CharSequence csq, final int start, final int end) throws java.io.IOException {
        try {
     ...
     */
    @java.lang.Override
    public java.io.Writer append(final java.lang.CharSequence csq) throws java.io.IOException {
        try {
            int len = 0;
            if (csq != null) {
                len = csq.length();
     ...
     */
    @java.lang.Override
    public void write(final char[] chr, final int st, final int len) throws java.io.IOException {
        try {
            beforeWrite(len);
     ...
     */
    @java.lang.Override
    public void write(final java.lang.String str, final int st, final int len) throws java.io.IOException {
        try {
            beforeWrite(len);
     ...
     */
    protected void beforeWrite(final int n) throws java.io.IOException {
    }
     ...
     */
    protected void afterWrite(final int n) throws java.io.IOException {
    }
     ...
     * @since 2.0
     */
    protected void handleIOException(final java.io.IOException e) throws java.io.IOException {
        throw e;
    }
}
