 ...
 */
/* method "isThresholdExceeded" was removed from this class because it was not covered by the test suite */
/* method "getThreshold" was removed from this class because it was not covered by the test suite */
/* method "getStream" was removed from this class because it was not covered by the test suite */
/* method "getByteCount" was removed from this class because it was not covered by the test suite */
/* method "resetByteCount" was removed from this class because it was not covered by the test suite */
/* method "thresholdReached" was removed from this class because it was not covered by the test suite */
public abstract class ThresholdingOutputStream extends java.io.OutputStream {
     ...
     * 		if an error occurs.
     */
    protected void checkThreshold(final int count) throws java.io.IOException {
