...
/* method "size" was removed from this class because it was not covered by the test suite */
...
/* method "writeTo" was removed from this class because it was not covered by the test suite */
public class ByteArrayOutputStream extends java.io.OutputStream {
     ...
     */
    private final java.util.List<byte[]> buffers = new java.util.ArrayList<>();
    ...
    public ByteArrayOutputStream() {
        this(org.apache.commons.io.output.ByteArrayOutputStream.DEFAULT_SIZE);
    }
    ...
    private void needNewBuffer(final int newcount) {
        if ((currentBufferIndex) < ((buffers.size()) - 1)) {
            ...
            if ((currentBuffer) == null) {
                ...
                newBufferSize = java.lang.Math.max(((currentBuffer.length) << 1), (newcount - (filledBufferSum)));
                filledBufferSum += currentBuffer.length;
            }
            (currentBufferIndex)++;
    ...
    public void write(final byte[] b, final int off, final int len) {
        ...
        synchronized(this) {
            ...
            while (remaining > 0) {
                final int part = java.lang.Math.min(remaining, ((currentBuffer.length) - inBufferPos));
                java.lang.System.arraycopy(b, ((off + len) - remaining), currentBuffer, inBufferPos, part);
                remaining -= part;
                if (remaining > 0) {
     ...
     * @since 1.4
     */
    public synchronized int write(final java.io.InputStream in) throws java.io.IOException {
        int readCount = 0;
        int inBufferPos = (count) - (filledBufferSum);
        int n = in.read(currentBuffer, inBufferPos, ((currentBuffer.length) - inBufferPos));
        while (n != (org.apache.commons.io.IOUtils.EOF)) {
            readCount += n;
            inBufferPos += n;
            count += n;
            if (inBufferPos == (currentBuffer.length)) {
