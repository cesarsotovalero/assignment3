...
public abstract class DirectoryWalker<T> {
     ...
     * 		the filter to apply to directories, null means visit all directories
     * @param fileFilter
     ...
     */
    protected final void walk(final java.io.File startDirectory, final java.util.Collection<T> results) throws java.io.IOException {
     ...
     * 		if an I/O Error occurs
     */
    private void walk(final java.io.File directory, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
     ...
     * 		if an I/O Error occurs
     */
    protected final void checkIfCancelled(final java.io.File file, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
     ...
     * 		if an I/O Error occurs
     */
    protected boolean handleIsCancelled(final java.io.File file, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
     ...
     * 		if an I/O Error occurs
     */
    protected void handleCancelled(final java.io.File startDirectory, final java.util.Collection<T> results, final org.apache.commons.io.DirectoryWalker.CancelException cancel) throws java.io.IOException {
     ...
     * 		if an I/O Error occurs
     */
    protected void handleStart(final java.io.File startDirectory, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
     ...
     * 		if an I/O Error occurs
     */
    protected boolean handleDirectory(final java.io.File directory, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
     ...
     * 		if an I/O Error occurs
     */
    protected void handleDirectoryStart(final java.io.File directory, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
     ...
     * 		the current directory level (starting directory = 0)
     * @param files
     * 		the files (possibly filtered) in the directory, may be {@code null}
     * @return the filtered list of files
     * @throws IOException
     * 		if an I/O Error occurs
     * @since 2.0
     */
    protected java.io.File[] filterDirectoryContents(final java.io.File directory, final int depth, final java.io.File[] files) throws java.io.IOException {
        return files;
    }
     ...
     * 		if an I/O Error occurs
     */
    protected void handleFile(final java.io.File file, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
     ...
     * 		if an I/O Error occurs
     */
    protected void handleRestricted(final java.io.File directory, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
     ...
     * 		if an I/O Error occurs
     */
    protected void handleDirectoryEnd(final java.io.File directory, final int depth, final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
     ...
     * 		if an I/O Error occurs
     */
    protected void handleEnd(final java.util.Collection<T> results) throws java.io.IOException {
        // do nothing - overridable by subclass
    }
}
