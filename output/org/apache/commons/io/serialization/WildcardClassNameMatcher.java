...
final class WildcardClassNameMatcher implements org.apache.commons.io.serialization.ClassNameMatcher {
     ...
     *
     * @param pattern
     * 		a {@link FilenameUtils#wildcardMatch} pattern.
     */
    public WildcardClassNameMatcher(final java.lang.String pattern) {
        this.pattern = pattern;
    }

    @java.lang.Override
    public boolean matches(final java.lang.String className) {
        return org.apache.commons.io.FilenameUtils.wildcardMatch(className, pattern);
    }
}
