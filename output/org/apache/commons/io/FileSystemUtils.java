...
public class FileSystemUtils {
    ...
    static {
        ...
        try {
            ...
            if (osName.contains("windows")) {
                ...
                if ((((((((osName.contains("linux")) || (osName.contains("mpe/ix"))) || (osName.contains("freebsd"))) || (osName.contains("openbsd"))) || (osName.contains("irix"))) || (osName.contains("digital unix"))) || (osName.contains("unix"))) || (osName.contains("mac os x"))) {
                    os = org.apache.commons.io.FileSystemUtils.UNIX;
                }else
                    if (((osName.contains("sun os")) || (osName.contains("sunos"))) || (osName.contains("solaris"))) {
                        os = org.apache.commons.io.FileSystemUtils.POSIX_UNIX;
     ...
     */
    @java.lang.Deprecated
    public static long freeSpace(final java.lang.String path) throws java.io.IOException {
        return org.apache.commons.io.FileSystemUtils.INSTANCE.freeSpaceOS(path, org.apache.commons.io.FileSystemUtils.OS, false, (-1));
    }
     ...
     */
    @java.lang.Deprecated
    public static long freeSpaceKb(final java.lang.String path) throws java.io.IOException {
     ...
     */
    @java.lang.Deprecated
    public static long freeSpaceKb(final java.lang.String path, final long timeout) throws java.io.IOException {
        return org.apache.commons.io.FileSystemUtils.INSTANCE.freeSpaceOS(path, org.apache.commons.io.FileSystemUtils.OS, true, timeout);
    }
     ...
     */
    @java.lang.Deprecated
    public static long freeSpaceKb(final long timeout) throws java.io.IOException {
     ...
     * 		if an error occurs when finding the free space
     */
    long freeSpaceOS(final java.lang.String path, final int os, final boolean kb, final long timeout) throws java.io.IOException {
        if (path == null) {
        ...
        switch (os) {
            ...
            case org.apache.commons.io.FileSystemUtils.POSIX_UNIX :
     ...
     * 		if an error occurs
     */
    long freeSpaceWindows(final java.lang.String path, final long timeout) throws java.io.IOException {
        java.lang.String normPath = org.apache.commons.io.FilenameUtils.normalize(path, false);
        if (normPath == null) {
            throw new java.lang.IllegalArgumentException(path);
        }
        if (((normPath.length()) > 0) && ((normPath.charAt(0)) != '"')) {
            normPath = ("\"" + normPath) + "\"";
        }
        // build and run the 'dir' command
        final java.lang.String[] cmdAttribs = new java.lang.String[]{ "cmd.exe" , "/C" , "dir /a /-c " + normPath };
        ...
        // all lines are blank
        throw new java.io.IOException(((("Command line 'dir /-c' did not return any info " + "for path '") + normPath) + "'"));
    }
     ...
     * 		if an error occurs
     */
    long parseDir(final java.lang.String line, final java.lang.String path) throws java.io.IOException {
     ...
     * 		if an error occurs
     */
    long freeSpaceUnix(final java.lang.String path, final boolean kb, final boolean posix, final long timeout) throws java.io.IOException {
        if (path.isEmpty()) {
        ...
        final java.lang.String[] cmdAttribs = ((flags.length()) > 1) ? new java.lang.String[]{ org.apache.commons.io.FileSystemUtils.DF , flags , path } : new java.lang.String[]{ org.apache.commons.io.FileSystemUtils.DF , path };
        // perform the command, asking for up to 3 lines (header, interesting, overflow)
        final java.util.List<java.lang.String> lines = performCommand(cmdAttribs, 3, timeout);
        if ((lines.size()) < 2) {
            // unknown problem, throw exception
            throw new java.io.IOException((((((("Command line '" + (org.apache.commons.io.FileSystemUtils.DF)) + "' did not return info as expected ") + "for path '") + path) + "'- response was ") + lines));
        }
        final java.lang.String line2 = lines.get(1);// the line we're interested in
        ...
        if ((tok.countTokens()) < 4) {
            ...
            if (((tok.countTokens()) == 1) && ((lines.size()) >= 3)) {
                final java.lang.String line3 = lines.get(2);// the line may be interested in
                
                tok = new java.util.StringTokenizer(line3, " ");
            }else {
                throw new java.io.IOException(((((("Command line '" + (org.apache.commons.io.FileSystemUtils.DF)) + "' did not return data as expected ") + "for path '") + path) + "'- check path is valid"));
            }
        }else {
     ...
     * 		if an error occurs
     */
    long parseBytes(final java.lang.String freeSpace, final java.lang.String path) throws java.io.IOException {
        try {
            final long bytes = java.lang.Long.parseLong(freeSpace);
            if (bytes < 0) {
                throw new java.io.IOException(((((("Command line '" + (org.apache.commons.io.FileSystemUtils.DF)) + "' did not find free space in response ") + "for path '") + path) + "'- check path is valid"));
            }
            return bytes;
        } catch (final java.lang.NumberFormatException ex) {
            throw new java.io.IOException(((((("Command line '" + (org.apache.commons.io.FileSystemUtils.DF)) + "' did not return numeric data as expected ") + "for path '") + path) + "'- check path is valid"), ex);
        }
    }
     ...
     * 		if an error occurs
     */
    java.util.List<java.lang.String> performCommand(final java.lang.String[] cmdAttribs, final int max, final long timeout) throws java.io.IOException {
        ...
        final java.util.List<java.lang.String> lines = new java.util.ArrayList<>(20);
     ...
     * 		if an error occurs
     */
    java.lang.Process openProcess(final java.lang.String[] cmdAttribs) throws java.io.IOException {
