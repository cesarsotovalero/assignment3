...
public class HexDump {
     ...
     */
    public static void dump(final byte[] data, final long offset, final java.io.OutputStream stream, final int index) throws java.io.IOException, java.lang.ArrayIndexOutOfBoundsException, java.lang.IllegalArgumentException {
     ...
     */
    private static java.lang.StringBuilder dump(final java.lang.StringBuilder _lbuffer, final long value) {
        for (int j = 0; j < 8; j++) {
            _lbuffer.append(org.apache.commons.io.HexDump._hexcodes[(((int) (value >> (org.apache.commons.io.HexDump._shifts[j]))) & 15)]);
        }
        return _lbuffer;
    }
     ...
     * @return StringBuilder containing the dumped value.
     */
    private static java.lang.StringBuilder dump(final java.lang.StringBuilder _cbuffer, final byte value) {
        for (int j = 0; j < 2; j++) {
            _cbuffer.append(org.apache.commons.io.HexDump._hexcodes[((value >> (org.apache.commons.io.HexDump._shifts[(j + 6)])) & 15)]);
        }
        return _cbuffer;
    }
}
