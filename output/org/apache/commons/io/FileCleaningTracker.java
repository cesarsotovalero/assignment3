...
public class FileCleaningTracker {
        ...
        public void run() {
            ...
            while (((exitWhenFinished) == false) || ((trackers.size()) > 0)) {
                try {
                    ...
                    final org.apache.commons.io.FileCleaningTracker.Tracker tracker = ((org.apache.commons.io.FileCleaningTracker.Tracker) (q.remove()));// cannot return null
    ...
    private static final class Tracker extends java.lang.ref.PhantomReference<java.lang.Object> {
         ...
         */
        Tracker(final java.lang.String path, final org.apache.commons.io.FileDeleteStrategy deleteStrategy, final java.lang.Object marker, final java.lang.ref.ReferenceQueue<? super java.lang.Object> queue) {
            super(marker, queue);
            this.path = path;
     ...
     */
    java.lang.ref.ReferenceQueue<java.lang.Object> q = new java.lang.ref.ReferenceQueue<>();
     ...
     * 		if the file is null
     */
    public void track(final java.io.File file, final java.lang.Object marker) {
     ...
     * 		if the file is null
     */
    public void track(final java.io.File file, final java.lang.Object marker, final org.apache.commons.io.FileDeleteStrategy deleteStrategy) {
        if (file == null) {
     ...
     * 		if the path is null
     */
    public void track(final java.lang.String path, final java.lang.Object marker) {
     ...
     * 		if the path is null
     */
    public void track(final java.lang.String path, final java.lang.Object marker, final org.apache.commons.io.FileDeleteStrategy deleteStrategy) {
        if (path == null) {
     ...
     * 		the strategy to delete the file, null means normal
     */
    private synchronized void addTracker(final java.lang.String path, final java.lang.Object marker, final org.apache.commons.io.FileDeleteStrategy deleteStrategy) {
        // synchronized block protects reaper
        if (exitWhenFinished) {
            throw new java.lang.IllegalStateException("No new trackers can be added once exitWhenFinished() is called");
        }
        if ((reaper) == null) {
            reaper = new org.apache.commons.io.FileCleaningTracker.Reaper();
            reaper.start();
        }
